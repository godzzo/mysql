...
Parser.prototype.write = function write(chunk) {
  ...
  while (!this._paused) {
    var packetHeader = this._readPacketHeader();

    if (!packetHeader) {
      if (this._inflateNextPacket()) {
        continue;
      } else {
        break;
      }
...
Parser.prototype._inflateNextPacket = function _inflateNextPacket() {
  if (!this._compressed || this._inflating) {
    return false;
  }

  var compressedPacketHeader = this._readCompressedPacketHeader();
...
Parser.prototype._readCompressedPacketHeader = function _readCompressedPacketHeader() {
...
Parser.prototype._readPacketHeader = function _readPacketHeader() {
  if (this._packetHeader) {
